    ...
    <div>
      ...
      <div className="w-full lg:w-[60%] p-4 lg:p-10 mx-auto">
          ...
          <ul className="ml-4 md:ml-8 list-disc text-base md:text-lg space-y-4 mb-8">
            <li className="hover:underline cursor-pointer"><Link href={'policy-ethics/authorship'}>Authorship Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/conflict_of_interest'}>Conflicts of Interest Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/copyright_license'}>Copyright and Licensing Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/open_access'}>Open Access Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/peer_review'}>Peer Review Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/plagiarism'}>Plagiarism Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/archiving'}>Archiving Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/service_terms'}>Terms of Service</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/privacy'}>Privacy Policy</Link></li>
            <li className="hover:underline cursor-pointer"><Link href={'/policy-ethics/cancel_refund'}>Cancellation/Refund Policy</Link></li>
          </ul>
