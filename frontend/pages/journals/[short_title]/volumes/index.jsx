  ...
  return (
    <div className="w-full min-h-screen flex flex-col  ">
      ...
      <div className="w-full h-full mx-auto bg-bleue-50">
        <div onClick={() => router.push(`/journals/${journal.short_title}`)} className="h-[200px] w-full px-[350px] flex items-center gap-10 p-4 cursor-pointer ">
        ...
        <main className="p-6 w-[60%] mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6">
            {journal.volumes
              ?.sort((a, b) => b.volumeNumber - a.volumeNumber) // Sorting in descending order
              .map((vol) => (
