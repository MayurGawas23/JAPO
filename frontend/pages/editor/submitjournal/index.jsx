...
const SubmitJournal = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!formData.journalName || !formData.short_title || !formData.publisher) {
    ...
    <div>
      ...
      <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4">
          ...
          {/* Journal Details */}
          <Input name="journalName" placeholder="Journal Title *" value={formData.journalName} onChange={handleChange} required />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
           ...
           <Input name="start_year" placeholder="Start Year *" value={formData.start_year} onChange={handleChange} required />
           </div>
          </div>
          ...
          <div className="flex">
            ...
            <Input name="frequency" placeholder="Frequency of Journal (per year)" value={formData.frequency} onChange={handleChange} />
          </div>
