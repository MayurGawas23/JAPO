    ...
    <div className="min-h-screen flex flex-col  bg-gray-100 relative">
      ...
      <div className="p-6 flex-1">
        ...
        <div className="max-w-4xl mx-auto bg-white p-6 rounded shadow">
          <h3 className="text-xl font-semibold mb-4">Papers for Reviews</h3>
            ...
            <ul className="space-y-4">
              {papers
                ...
                .map((paper) => (
                  ...
                  <li key={paper.paperId}  onClick={() => router.push(`/editor/assign-reviewers/${paper.paperId}`)} className="p-4 border rounded-lg flex justify-between items-center cursor-pointer hover:bg-slate-100">
                    <div>
...
export const getServerSideProps = async (context) => {
  ...
  try {
    ...
    return {
      props: {
           papers: Array.isArray(papersRes.data) ? papersRes.data : [],
    reviewers: Array.isArray(reviewersRes.data) ? reviewersRes.data : [],
        initialError: "",
      },
    };
  } catch (err) {
