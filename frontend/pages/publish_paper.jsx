...
const PaperSubmit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("pklijde", uploadedFileUrl)

      const paperData = { paperTitle, authors, indexTerms, abstract, references, pages, doi, publicationDate , pdf ,finalpdf:uploadedFileUrl };
     await fetch(
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-xl shadow-lg">
      <h2 className="text-2xl font-bold text-center mb-6">Publish Paper for Journal</h2>
