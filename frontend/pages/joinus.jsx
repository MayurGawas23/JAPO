      ...
      <div className="flex flex-col lg:flex-row h-full w-full">
        ...
        <div className="w-full lg:w-[60%] p-4 lg:p-10">
          ...
          <p className="mb-6 text-justify">
            ...
            invited to join JAPO Publishers Journal free-of-charge as members
            of International Advisory Board, Editorial Board, or Reviewers
            Board.
            <br />
            If you are interested in joining JAPO Publishers Journal, fill out
            the online form or send a filled Membership Form with your updated
            CV to{' '}
            <span className="font-semibold text-gray-700">
              editor.support@JAPO.org.in
            </span>
